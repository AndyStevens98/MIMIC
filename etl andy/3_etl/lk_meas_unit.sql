...
CREATE TABLE public.lk_meas_operator_concept AS
SELECT
...
CREATE TABLE public.tmp_meas_unit AS
SELECT
...
CREATE TABLE public.lk_meas_unit_concept AS
SELECT
...
DROP TABLE IF EXISTS public.tmp_meas_unit;
