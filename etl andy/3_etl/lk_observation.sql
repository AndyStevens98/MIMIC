...
CREATE TABLE public.lk_observation_clean AS
-- rule 1, insurance
SELECT
...
INSERT INTO public.lk_observation_clean
SELECT
    src.subject_id                  AS subject_id,
    src.hadm_id                     AS hadm_id,
...
CREATE TABLE public.lk_obs_admissions_concept AS
SELECT DISTINCT
...
FROM
    public.lk_observation_clean src
LEFT JOIN
...
CREATE TABLE public.lk_observation_mapped AS
SELECT
...
FROM
    public.lk_observation_clean src
LEFT JOIN
    public.lk_obs_admissions_concept lc
