...
-- Rule 1
-- -------------------------------------------------------------------
CREATE TABLE `@etl_project`.@etl_dataset.lk_prescriptions_clean AS
SELECT
...
-- -------------------------------------------------------------------
CREATE TABLE `@etl_project`.@etl_dataset.lk_pr_ndc_concept AS
SELECT DISTINCT
...
-- Rule 1
-- -------------------------------------------------------------------
CREATE TABLE `@etl_project`.@etl_dataset.lk_pr_gcpt_concept AS
SELECT DISTINCT
...
-- Rule 1
-- -------------------------------------------------------------------
CREATE TABLE `@etl_project`.@etl_dataset.lk_pr_route_concept AS
SELECT DISTINCT
...
CREATE TABLE `@etl_project`.@etl_dataset.lk_drug_mapped AS
SELECT
    src.hadm_id                                     AS hadm_id,
    src.subject_id                                  AS subject_id,
