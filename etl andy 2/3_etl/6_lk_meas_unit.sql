...
CREATE TABLE mimiciv_etl.lk_meas_operator_concept AS
SELECT
...
CREATE TABLE mimiciv_etl.tmp_meas_unit AS
SELECT
...
CREATE TABLE mimiciv_etl.lk_meas_unit_concept AS
SELECT
...
DROP TABLE IF EXISTS mimiciv_etl.tmp_meas_unit;
