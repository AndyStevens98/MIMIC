...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_observation_period_clean AS
SELECT
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_observation_period AS
SELECT
    src.person_id               AS person_id,
...
CREATE TABLE `@etl_project`.@etl_dataset.cdm_observation_period
(
...
SELECT
    md5(gen_random_uuid()::text)           AS observation_period_id,
    src.person_id                               AS person_id,
