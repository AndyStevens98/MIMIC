...
CREATE TABLE `@etl_project`.@etl_dataset.lk_join_voc_drug
AS SELECT DISTINCT
...
-- -------------------------------------------------------------------
CREATE TABLE `@etl_project`.@etl_dataset.tmp_pretarget_drug
AS SELECT
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_subenddates_un_drug
    AS SELECT
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_subenddates_rows_drug
AS SELECT
    person_id                       AS person_id,
    ingredient_concept_id           AS ingredient_concept_id,
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_subenddates_drug
AS SELECT
    person_id               AS person_id,
    ingredient_concept_id   AS ingredient_concept_id,
...
CREATE TABLE `@etl_project`.@etl_dataset.temp_ends_drug
AS SELECT
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_sub_drug
AS SELECT
    ROW_NUMBER() OVER (
        PARTITION BY
            person_id,
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_finaltarget_drug
AS SELECT
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_enddates_un_drug
    AS SELECT
        person_id                                       AS person_id,
        ingredient_concept_id                           AS ingredient_concept_id,
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_enddates_rows_drug
AS SELECT
    person_id                       AS person_id,
    ingredient_concept_id           AS ingredient_concept_id,
    event_date                      AS event_date,
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_enddates_drug
AS SELECT
    person_id                                       AS person_id,
    ingredient_concept_id                           AS ingredient_concept_id,
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_drugera_ends_drug
AS SELECT
...
CREATE TABLE `@etl_project`.@etl_dataset.cdm_drug_era
(
...
SELECT
    md5(gen_random_uuid()::text)                                   AS drug_era_id,
    person_id                                                           AS person_id,
