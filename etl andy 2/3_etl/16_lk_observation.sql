...
CREATE TABLE `@etl_project`.@etl_dataset.lk_observation_clean AS
-- rule 1, insurance
SELECT
...
CREATE TABLE `@etl_project`.@etl_dataset.lk_obs_admissions_concept AS
SELECT DISTINCT
...
CREATE TABLE `@etl_project`.@etl_dataset.lk_observation_mapped AS
SELECT
