...
-- condition.
-- -------------------------------------------------------------------
CREATE TABLE `@etl_project`.@etl_dataset.tmp_target_condition
AS SELECT
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_dates_un_condition
    AS SELECT
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_dates_rows_condition
AS SELECT
    person_id                       AS person_id,
    condition_concept_id            AS condition_concept_id,
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_enddates_condition
AS SELECT
    person_id                                       AS person_id,
    condition_concept_id                            AS condition_concept_id,
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_conditionends
AS SELECT
...
CREATE TABLE `@etl_project`.@etl_dataset.cdm_condition_era
(
...
SELECT
    md5(gen_random_uuid()::text)               AS condition_era_id,
    person_id                                       AS person_id,
    condition_concept_id                            AS condition_concept_id,
