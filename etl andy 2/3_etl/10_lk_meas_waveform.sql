...
CREATE TABLE `@etl_project`.@etl_dataset.lk_waveform_clean AS
SELECT
...
CREATE TABLE `@etl_project`.@etl_dataset.lk_wf_hadm_id AS
SELECT
...
CREATE TABLE `@etl_project`.@etl_dataset.lk_meas_waveform_mapped AS
SELECT
