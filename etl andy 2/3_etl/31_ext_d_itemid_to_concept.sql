...
CREATE TABLE `@etl_project`.@etl_dataset.d_items_to_concept AS
WITH
counts AS
(
...
CREATE TABLE `@etl_project`.@etl_dataset.d_labitems_to_concept AS
WITH
counts AS
(
    SELECT
...
CREATE TABLE `@etl_project`.@etl_dataset.d_micro_to_concept AS
WITH
counts AS
(
    SELECT
