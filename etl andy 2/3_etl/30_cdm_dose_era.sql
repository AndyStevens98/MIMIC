...
CREATE TABLE `@etl_project`.@etl_dataset.cdm_dose_era
(
...
-- -------------------------------------------------------------------
CREATE TABLE `@etl_project`.@etl_dataset.tmp_drugIngredientExp AS
SELECT
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_drugWithDose AS
SELECT
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_cteDoseTarget AS
SELECT
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_cteDoseEndDates_rawdata AS
SELECT
    person_id                                       AS person_id,
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_cteDoseEndDates_e AS
SELECT
    person_id                                                                   AS person_id,
    drug_concept_id                                                             AS drug_concept_id,
    unit_concept_id                                                             AS unit_concept_id,
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_cteDoseEndDates AS
SELECT
    person_id                                       AS person_id,
    drug_concept_id                                 AS drug_concept_id,
    unit_concept_id                                 AS unit_concept_id,
...
CREATE TABLE `@etl_project`.@etl_dataset.tmp_cteDoseFinalEnds AS
SELECT
...
SELECT
    md5(gen_random_uuid()::text)   AS dose_era_id,
    person_id                           AS person_id,
    drug_concept_id                     AS drug_concept_id,
    unit_concept_id                     AS unit_concept_id,
    dose_value                          AS dose_value,
