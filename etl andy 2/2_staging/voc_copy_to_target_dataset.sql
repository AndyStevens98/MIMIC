...
CREATE TABLE `@etl_project`.@etl_dataset.voc_concept AS
SELECT * FROM `@voc_project`.@voc_dataset.concept
;

CREATE TABLE `@etl_project`.@etl_dataset.voc_concept_relationship AS
SELECT * FROM `@voc_project`.@voc_dataset.concept_relationship
;

CREATE TABLE `@etl_project`.@etl_dataset.voc_vocabulary AS
SELECT * FROM `@voc_project`.@voc_dataset.vocabulary
;

-- not affected by custom mapping

CREATE TABLE `@etl_project`.@etl_dataset.voc_domain AS
SELECT * FROM `@voc_project`.@voc_dataset.domain
;
CREATE TABLE `@etl_project`.@etl_dataset.voc_concept_class AS
SELECT * FROM `@voc_project`.@voc_dataset.concept_class
;
CREATE TABLE `@etl_project`.@etl_dataset.voc_relationship AS
SELECT * FROM `@voc_project`.@voc_dataset.relationship
;
CREATE TABLE `@etl_project`.@etl_dataset.voc_concept_synonym AS
SELECT * FROM `@voc_project`.@voc_dataset.concept_synonym
;
CREATE TABLE `@etl_project`.@etl_dataset.voc_concept_ancestor AS
SELECT * FROM `@voc_project`.@voc_dataset.concept_ancestor
;
CREATE TABLE `@etl_project`.@etl_dataset.voc_drug_strength AS
