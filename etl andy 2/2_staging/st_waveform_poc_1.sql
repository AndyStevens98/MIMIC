...
CREATE TABLE `@etl_project`.@etl_dataset.src_waveform_header
(
    reference_id            STRING,
...
CREATE TABLE `@etl_project`.@etl_dataset.src_waveform_dx
(
...
CREATE TABLE `@etl_project`.@etl_dataset.src_waveform_mx
(
    subject_id              INT64,
    reference_id            STRING,  -- FK to the header
    waveform_id             STRING,  -- row number inside the reference_id
...
CREATE TABLE `@etl_project`.@etl_dataset.src_waveform_subject AS
SELECT
    subject_id,
    hadm_id
FROM
