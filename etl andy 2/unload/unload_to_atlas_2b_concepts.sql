...
CREATE TABLE `@atlas_project`.@atlas_dataset.2b_concept AS
SELECT
    concept_id,
    concept_name,
    domain_id,
...
CREATE TABLE `@atlas_project`.@atlas_dataset.2b_concept_relationship AS
SELECT
    concept_id_1,
    concept_id_2,
    relationship_id,
...
CREATE TABLE `@atlas_project`.@atlas_dataset.2b_vocabulary AS
SELECT
    vocabulary_id,
    vocabulary_name,
